...
class User
{
	...
	public function getUsersListing()
	{
		...
		while ($user = $result->fetch_assoc()) {
			...
			$rows[] = $type;
			$rows[] = $status;
			$rows[] = '<a href="edit_users.php?id=' . $user["id"] . '" class="btn btn-warning btn-xs update">Editar</a>';
			$rows[] = '<button type="button" name="delete" id="' . $user["id"] . '" class="btn btn-danger btn-xs delete">Eliminar</button>';
			$users[] = $rows;
		}
