...
class Category
{
	...
	public function getCategoryListing()
	{
		...
		while ($category = $result->fetch_assoc()) {
			...
			$rows[] = $category['id'];
			$rows[] = $category['name'];
			$rows[] = '<a href="edit_categories.php?id=' . $category["id"] . '" class="btn btn-warning btn-xs update">Editar</a>';
			$rows[] = '<button type="button" name="delete" id="' . $category["id"] . '" class="btn btn-danger btn-xs delete">Eliminar</button>';
			$categories[] = $rows;
		}
